  ...
  <div class="small-9 head-mobLt column">
      <div class="head-mobLogo">
        <a href="<?php echo site_url(); ?>">
          <img src="<?php echo $headerLogo['url']; ?>" alt="<?php $headerLogo['alt']; ?>" class="w100">
        </a>
      </div>
  </div>
...
<header class="hide-for-small-only clearfix special-color">
	<div class="row expanded padd align-middle">
    	<div class="large-5 align-right">
        	<?php 
				$posts = get_field('left_links', 'option');
				if( $posts ): ?>
					<ul id="left_links" class="desktop-menu dropdown menu vertical align-right" data-toggle data-dropdown-menu data-close-on-click-inside>
        ...
        <div class="large-5 align-left">
        	<?php 
				$posts = get_field('right_links', 'option');
				if( $posts ): ?>
					<ul id="right_links" class="desktop-menu dropdown menu vertical align-left" data-toggle data-dropdown-menu data-close-on-click-inside>
					<?php foreach( $posts as $post): // variable must be called $post (IMPORTANT) ?>
						<?php setup_postdata($post); ?>
        ...
        <div class="large-12 align-right extra">
