...
if ( ! class_exists( 'Sky_Protocol_Relative_Theme_Assets' ) ) :
	class Sky_Protocol_Relative_Theme_Assets {
		/**
	...
	$sky_protocol_relative_theme_assets = new Sky_Protocol_Relative_Theme_Assets;
endif;
